...
const CreateTestimonial = ({placeholder}) => {
    ...
    const onSubmit = async(data) => {
        ...
        const req =await fetch(`${apiUrl}/testimonial/create`, {
            method : 'POST',
            headers : {
  ...
  return (
    <div className="container my-4">
      ...
      <div className="col-md-8">
        <h2 className="services-title">Testimonial/Add New</h2>
