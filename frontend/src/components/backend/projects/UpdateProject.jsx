...
const UpdateProject = ({ placeholder }) => {
  ...
  const {
    ...
    defaultValues: async () => {
      const req = await fetch(`${apiUrl}/project/show/${params.id}`, {
        method: "GET",
        headers: {
  ...
  const onSubmit = async (data) => {
    ...
    const req = await fetch(`${apiUrl}/project/update/${params.id}`, {
      method: "PUT",
      headers: {
            ...
            <div className="container my-5">
              <div className="row align-items-center mb-5">
                ...
                <div className="col-md-4 text-sm-end">
                  <Link
                    to="/admin/projects"
                    className="btn btn-danger btn-md services-btn"
                  >
                    Back
                  </Link>
                </div>
                        ...
                        <div className="mb-3">
                          ...
                          {project.image && (
                            <img
                              ...
                              src={`${fileUrl}uploads/project/small/${project.image}`}
                              alt=""
                            />
                          )}
                        </div>
